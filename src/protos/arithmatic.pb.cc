...
void InitDefaultsCalculation() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCalculationImpl);
}
...
void InitDefaultsOneImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_arithmatic_2eproto::InitDefaultsCalculation();
  {
...
void InitDefaultsOne() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsOneImpl);
}
...
One::One()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_arithmatic_2eproto::InitDefaultsOne();
  }
  SharedCtor();
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessage(input, add_calc()));
        } else {
          goto handle_unusual;
        }
        break;
